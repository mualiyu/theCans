...
@section('content')
     <!-- Page content-->
          <div class="col-lg-9 pt-4 pb-2 pb-sm-4">
            <h1 class="h2 mb-4">Add Community</h1>
            <!-- Basic info-->
            @include('layouts.flash')
            <section class="card border-0 py-1 p-md-2 p-xl-3 p-xxl-4 mb-4">
              <form action="{{route('store_community')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  <div class="d-flex align-items-center mt-sm-n1 pb- mb-0 mb-lg-1 mb-xl-3">
                      <p>Add community information below</p>
                  ...
                  <div class="row g-3 g-sm-4 mt-0 mt-lg-2">
                    ...
                    <div class="col-12 d-flex justify-content-end pt-3 end">
                      ...
                      <button class="btn btn-primary ms-3" type="submit">Add Community</button>
                    </div>
                  </div>
                </div>
              </form>
