...
<section class="container pt-5 pb-sm-3 mt-5 mb-2 mb-md-3 mb-lg-4 mb-xxl-5">
    ...
    <nav aria-label="breadcrumb">
        <ol class="pt-lg-3 pb-lg-4 pb-2 breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">Successful Payment</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{$booking->b_id}}</li>
        </ol>
    </nav>

    @include('layouts.flash')
    <div class="card bg-primary bg-opacity-10 border-0 py-1 p-md-2 p-xl-3 p-xxl-4 mb-4">
        <div class="card-body">
            <div class="d-flex align-items-center mt-sm-n1 pb-4 mb-0 mb-lg-1 mb-xl-3">
                <i class="ai-user text-primary lead pe-1 me-2"></i>
                <h2 class="h4 mb-0">Booking info</h2>
                <a class="btn btn-sm btn-primary ms-auto" href="#">
                    ...
                    <table class="table mb-0">
                        <tbody>
                            <tr>
                                ...
                                <td class="border-0 text-dark fw-medium py-1 ps-3">{{$booking->customer_first_name}} {{$booking->customer_last_name}}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="border-0 text-dark fw-medium py-1 ps-3">{{$booking->start_date->format('d M, Y')}}</td>
                            </tr>
                            <tr>
