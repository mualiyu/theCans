                ...
                <div class="card-body">
                  ...
                  <div class="row g-3 g-sm-4 mt-0 mt-lg-2">
                    <div class="col-sm-12">
                      ...
                      <input class="form-control" type="text" name="title" value="" id="fjn">
                    </div>
                    <div class="col-sm-12">
                      <label class="form-label" for="jn">content</label>
                      <textarea class="form-control"  rows="7" name="content" value="" id="fjn"></textarea>
                    </div>
                    ...
                    <div class="col-12 d-flex justify-content-end pt-3 end">
                      ...
                      <button class="btn btn-primary ms-3" type="submit">Add FAQ</button>
                    </div>
                  </div>
                </div>
              </form>
