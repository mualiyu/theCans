                              ...
                              <tbody>
                                <tr>
                                  <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;" align="left" bgcolor="#ffffff">
                                    <h1 class="h3 fw-700" style="padding-top: 0; padding-bottom: 0; font-weight: 700 !important; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;" align="left">Booking Confirmation</h1>
                                    ...
                                    <p class="" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">Thank you for booking a space with us! Your booking has been successfully registered in our system.</p>
                                    <table class="s-4 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                      <tbody>
                                        <tr>
                                          <td style="line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;" align="left" width="100%" height="16">
                                    ...
                                    <p style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">Please proceed with the payment to confirm your booking. <a href="{{route('main.booking.failed', ['b_id' => $booking->b_id])}}">Click here to continue making payments</a> or copy the link below</p>
                                    <p style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left"><a href="{{route('main.booking.failed', ['b_id' => $booking->b_id])}}"> {{route('main.booking.failed', ['b_id' => $booking->b_id])}}</a></p>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
