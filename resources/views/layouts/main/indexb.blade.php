...
<html lang="en" data-bs-theme="light">
  ...
  <body>
      ...
      <div class="container pt-md-2 pt-lg-3 pt-xl-4">
        <div class="row pb-5 pt-sm-2 mb-lg-2">
          <div class="col-md-12 col-lg-3 pb-2 pb-lg-0 mb-4 mb-lg-0">
            ...
            <div class="d-flex">
              <a class="btn btn-icon btn-sm btn-secondary btn-facebook rounded-circle me-3" href="landing-marketing-agency.html#" aria-label="Facebook">
                <i class="ai-facebook"></i>
              </a>
              <a class="btn btn-icon btn-sm btn-secondary btn-instagram rounded-circle me-3" href="landing-marketing-agency.html#" aria-label="Instagram">
                <i class="ai-instagram"></i>
              </a>
              <a class="btn btn-icon btn-sm btn-secondary btn-linkedin rounded-circle" href="landing-marketing-agency.html#" aria-label="LinkedIn">
          ...
          <div class="col-sm-3 col-lg-2 offset-xl-1 mb-4 mb-sm-0">
            <ul class="nav flex-column">
              <li><a class="nav-link py-1 px-0" href="landing-marketing-agency.html#">Services</a></li>
              <li><a class="nav-link py-1 px-0" href="landing-marketing-agency.html#">Reviews</a></li>
              <li><a class="nav-link py-1 px-0" href="landing-marketing-agency.html#">Case studies</a></li>
              <li><a class="nav-link py-1 px-0" href="landing-marketing-agency.html#">Privacy policy</a></li>
            </ul>
          </div>
    ...
    <!-- Back to top button -->
    <a class="btn-scroll-top" href="landing-marketing-agency.html#top" data-scroll aria-label="Scroll back to top">
